...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640] mx-auto flex justify-between items-center p-4'>
      ...
      {/* {slide drawer } */}
      <div className={nav ?"fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-700" : "fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300"}>
        <AiOutlineClose onClick={
          ()=>setNav(!nav)
        } size={30} className='absolute right-4
        top-4 cursor-pointer'/>
        <h2 className='text-2xl p-4'>Best <span className='
        font-bold'>Eats</span></h2>
        <nav>
          <ul className='flex flex-col p-4 text-gray-800'>
            ...
            <li className='text-xl py-4  flex'><FaUserFriends size={25} className='mr-4' />Invites Friends </li>
